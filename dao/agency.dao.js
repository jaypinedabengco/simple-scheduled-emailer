        ...
        database.getConnection((err, connection) => {
            ...
            var sql = `
                SELECT DISTINCT 
                    ...
                    agency_address.street_1 Head_Office_Address_Street_1,
                    agency_address.street_2 Head_Office_Address_Street_2,
                    agency_address.city Head_Office_Address_City,
                    agency_address.region Head_Office_Address_Region,
                    agency_address.post_code Head_Office_Address_Post_Code,
